...
\begin{enumerate}
    ...
    \item Expected Shortfall ($ESF_{10\%}$):
...
\begin{center}
    \textbf{Решение}
\end{center}
Код и вычисления: \href{https://github.com/Klimgit/investment/blob/main/task4.ipynb}{github.com/Klimgit/investment/blob/main/task4.ipynb}.

\textbf{Ответ:}
\begin{itemize}
    \item Оптимальные веса по Келли: $w_{\mathrm{AAPL}} \approx 2{,}31$, $w_{\mathrm{TSLA}} \approx 0{,}33$
    \item Доля в безрисковом активе: $w_0 \approx -1{,}64$ (кредитная позиция)
    \item Норма доходности на тестовой выборке (2025): $\approx 19{,}5\%$
    \item Sharpe Ratio: $\approx 0{,}26$
\end{itemize}
...
Из $w_0 + w_1 + w_2 = 1$ получаем $w_0 = 1 - w_1 - w_2$, подставляем в $\mu_p$:
$$\mu_p = 6 + w_1(8-6) + w_2(20-6) = 6 + 2w_1 + 14w_2$$
Ограничение активно (иначе можно было бы взять ещё более доходный портфель), поэтому
$$25w_1^2 + 400w_2^2 = 225.$$
Функция Лагранжа:
$$L = 6 + 2w_1 + 14w_2 - \lambda(25w_1^2 + 400w_2^2 - 225)$$
Условия ККТ:
...
$$25\left(\frac{1}{25\lambda}\right)^2 + 400\left(\frac{7}{400\lambda}\right)^2 = 225
\implies \frac{65}{400\lambda^2} = 225
\implies \lambda = \frac{\sqrt{65}}{300}$$

\begin{center}\textbf{Вычисление весов.}\end{center}    
Подставляем $\lambda$ в формулы для $w_1$ и $w_2$:
$$w_1 = \frac{1}{25 \cdot \frac{\sqrt{65}}{300}} = \frac{300}{25\sqrt{65}} = \frac{12}{\sqrt{65}}, \qquad
w_2 = \frac{7}{400 \cdot \frac{\sqrt{65}}{300}} = \frac{2100}{400\sqrt{65}} = \frac{21}{4\sqrt{65}}.$$
$$w_1 = \frac{12 \cdot 2}{2\sqrt{65}} = \frac{24}{\sqrt{260}}, \qquad
w_2 = \frac{21/2}{(4/2)\sqrt{65}} = \frac{10.5}{\sqrt{260}}.$$
Доля в безрисковом активе:
$$w_0 = 1 - w_1 - w_2 = 1 - \frac{24 + 10.5}{\sqrt{260}} = 1 - \frac{34.5}{\sqrt{260}}.$$

\begin{center}\textbf{Максимальная средняя прибыль.}\end{center}
Подставляем веса в $\mu_p = 6 + 2w_1 + 14w_2$ :
$$\mu_p = 6 + 2 \cdot \frac{12}{\sqrt{65}} + 14 \cdot \frac{21}{4\sqrt{65}}
= 6 + \frac{24}{\sqrt{65}} + \frac{294}{4\sqrt{65}}
= 6 + \frac{390}{4\sqrt{65}}.$$
Домножаем дробь на $\dfrac{\sqrt{65}}{\sqrt{65}}$:
$$\frac{390}{4\sqrt{65}} = \frac{390\sqrt{65}}{260} = \frac{3\sqrt{65}}{2}.$$
Эквивалентная запись: $\dfrac{3\sqrt{65}}{2} = \dfrac{3 \cdot 2\sqrt{65}}{4} = \dfrac{3\sqrt{260}}{4}$.

\textbf{Ответ:}
\begin{itemize}
    \item Максимальная средняя прибыль: $\mu_p = 6 + \dfrac{3\sqrt{260}}{4} = 6 + \dfrac{3\sqrt{65}}{2} \approx 18{,}093\%$
    \item Веса в рисковые активы: $w_1 = \dfrac{24}{\sqrt{260}} = \dfrac{12}{\sqrt{65}} \approx 148{,}8\%$, $w_2 = \dfrac{10.5}{\sqrt{260}} = \dfrac{21}{4\sqrt{65}} \approx 65{,}1\%$
    \item Доля в безрисковом активе: $w_0 = 1 - \dfrac{34.5}{\sqrt{260}} \approx -114{,}0\%$ (кредитная позиция)
\end{itemize}
\end{document}